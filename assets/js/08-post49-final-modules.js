...
(function(){
  ...
  var SITE_VERSION='57_7physicalprint';
...
(function(){
  'use strict';
  var VERSION='57.7.0-physical-print-width';
  var SITE_VERSION='57_7physicalprint';
...
(function(){
  ...
  function preparePrintHtml(html,autoPrint){
    ...
    if(html.indexOf('data-hp-print-repair')<0){
      var repair='<style data-hp-print-repair="57.7">'+printRepairCss()+'</style>';
...
(function(){
  ...
  function html(){
    ...
    var c=s.counts;
    return '<h3>V57.7 Print Reliability Gate — فحص رأس المال والسيولة</h3>'+
  ...
  function boot(){try{bind();wrapShowPage();place();setTimeout(place,800);setInterval(function(){if((window.activePage||'')==='sync'||document.querySelector('#dr-sync.open,#dr-sync .drawer'))place()},2500);console.log('Haydar Pack V57.7 Print Reliability Gate loaded',VERSION)}catch(e){try{console.error(e)}catch(_){}}}
...
/* ===== V57.7 Print Reliability + Smart Summary (no new JS files) ===== */
(function(){
  'use strict';
  var VERSION='57.7.0-physical-print-width', SITE_VERSION='57_7physicalprint';
