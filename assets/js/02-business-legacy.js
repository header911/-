/* Haydar Pack V50 final-stable bundle: 02-business-legacy.js
...
(function(){
  ...
  window.__HP_LEGACY_DISABLED_printSelectedClientQuote=function(cid){printClientDoc(cid,'quote')};
  window.__HP_LEGACY_DISABLED_printSelectedClientInvoice=function(cid){printClientDoc(cid,'invoice')};
  window.__HP_LEGACY_DISABLED_printSelectedClientStatement=function(cid){printClientStatement(cid)};
  window.__HP_LEGACY_DISABLED_printSelectedFactoryStatement=function(fid){printFactoryStatement(fid)};
