# Haydar Pack V53 - File Map

نسخة V53 مبنية على V52 وتضيف طبقة تقارير مالية أعمق بدون لمس Apps Script أو الداتا.
...
- `assets/js/10-reports-finance-insights.js` — Finance Insights & Drilldown V53.

## ملفات مهمة

- `index.html` — ترتيب تحميل الملفات.
- `assets/css/styles.css` — التصميم، ويتضمن تنسيقات V52 و V53.
- `sw.js` — كاش PWA محدث على `v=53financeinsights`.
